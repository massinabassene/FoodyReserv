...
import { Home, Menu, ShoppingBag, Calendar, MessageSquare, Mail, LogOut, User, Settings, Shield, Bell , Users} from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 col-span-1 lg:col-span-3">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <a href="/manager" className="bg-yellow-100 hover:bg-yellow-200 p-4 rounded-lg flex flex-col items-center justify-center transition-all duration-300">
                <Home size={32} className="text-yellow-600 mb-2" />
                <span className="text-gray-800 font-medium">Tableau de bord</span>
              </a>
              <a href="/manager/menu" className="bg-green-100 hover:bg-green-200 p-4 rounded-lg flex flex-col items-center justify-center transition-all duration-300">
                <Menu size={32} className="text-green-600 mb-2" />
                <span className="text-gray-800 font-medium">Gestion du menu</span>
              </a>
              <a href="/manager/commandes" className="bg-blue-100 hover:bg-blue-200 p-4 rounded-lg flex flex-col items-center justify-center transition-all duration-300">
                <ShoppingBag size={32} className="text-blue-600 mb-2" />
                <span className="text-gray-800 font-medium">Commandes</span>
              </a>
              <a href="/manager/reservations" className="bg-purple-100 hover:bg-purple-200 p-4 rounded-lg flex flex-col items-center justify-center transition-all duration-300">
