...
import { User, Home, ShoppingBag, Calendar, MessageSquare, Mail, LogOut, Edit, MapPin, Phone, Menu, Users } from 'lucide-react';
    ...
    const fetchUserData = async () => {
      ...
      if (token && user) {
        try {
          ...
          const response = await getUser(user.userId, 'MANAGER');
    ...
    <div className="min-h-screen flex bg-gray-100">
      ...
      <div className="w-64 bg-white shadow-md">
        ...
        <div className="absolute bottom-0 w-64 border-t p-4 space-y-2">
          <a href="/manager/profile" className="flex items-center text-gray-700 bg-yellow-50 border-l-4 border-yellow-500 transition-all duration-300">
